...
BEGIN
  ...
  return query select true, '转盘结算成功！获得 2 积分。商家热度 +10', next_total_points, next_spin_count, next_restaurant_hot_score;
END;
$$;
