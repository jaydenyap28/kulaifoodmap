        ...
        <div className="max-w-[1600px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="relative w-full sm:w-80">
            ...
            <input 
              ...
              className="w-full pl-11 pr-12 py-3 bg-[#1e1e1e] border border-gray-700 rounded-full text-base text-gray-200 focus:outline-none focus:border-white focus:ring-1 focus:ring-white transition-all placeholder-gray-600"
            />
          </div>
        </div>
      </div>
