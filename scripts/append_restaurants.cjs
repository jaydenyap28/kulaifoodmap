...
const newRestaurants = [
  ...
  },
  {
    ...
    category: ["西餐"], // Mapped from Cafe to Western for Nando's
  ...
  },
  {
    ...
    address: "Kulai, Johor", // Placeholder
  ...
  },
  {
    ...
    category: ["面类"],
    image: "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3" // Generic placeholder
  },
  {
...
const newItemsStr = newRestaurants.map(r => {
  const item = {
    id: currentId++,
    name: r.name,
    name_en: r.name_en,
    ...
    category: r.category,
    categories: r.category, // Duplicate as per existing structure
    rating: 0,
    image: r.image,
    subStalls: [],
    price_range: "RM 10-20", // Default
    menu_link: "",
    website_link: "",
    delivery_link: "",
    isVegetarian: false,
...
if (lastIndex !== -1) {
  ...
  console.log('Successfully appended new restaurants.');
} else {
  console.error('Could not find closing array bracket.');
}
